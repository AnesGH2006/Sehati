...
function GoogleButton({ loading }: { loading: boolean }) {
  const handleGoogleLogin = () => {
    // يحوّل المستخدم لـ OAuth endpoint في السيرفر
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full h-12 flex items-center justify-center gap-3 border border-border/60 rounded-lg bg-background hover:bg-muted/50 transition-colors text-sm font-medium text-foreground disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
    >
      <GoogleIcon />
