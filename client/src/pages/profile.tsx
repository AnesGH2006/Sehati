...
import { MapPin, Star, MessageCircle, Share2, Heart, CheckCircle2, Clock, Globe, Phone, User, Briefcase, Banknote, ThumbsUp } from "lucide-react";
...
export default function Profile() {
  ...
  // Check if customer has chatted with this artisan
